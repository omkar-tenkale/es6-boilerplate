...
game.object.Kite = me.Sprite.extend({
	init: function(x, y, settings = {}){
		...
		settings.frameheight = settings.frameheight || 240;
		...
		this.addAnimation('idle', [{ name: "obstacles_layangan", delay: 1 }]);
		this.setCurrentAnimation('idle');
		this.isKinematic = false;

		this.body = new me.Body(this);
		var bodyShapePos = {x: (this.anchorPoint.x * this.width), y:(this.anchorPoint.y * this.height)}
		this.body.addShape( me.pool.pull("me.Rect", 0 - bodyShapePos.x, 0 - bodyShapePos.y, 108, 127) );
